...
<template>
  <nav class="min-h-[64px] sticky top-0 z-50 w-full backdrop-blur py-4 bg-background/70">
    <div class="flex w-full max-w-6xl mx-auto px-4 justify-between items-center">
      <!-- Logo -->
      <NuxtImg src="/images/kejo.svg" alt="logo" width="40" height="40" class="w-[40px] h-[40px]" />
